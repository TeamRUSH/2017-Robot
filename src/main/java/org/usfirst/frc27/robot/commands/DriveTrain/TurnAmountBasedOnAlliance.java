 ...
 */
public class TurnAmountBasedOnAlliance extends Command {
	...
	public TurnAmountBasedOnAlliance(double angle){
		this.angle = angle;
	}

	protected void initialize() {
		targetAngle = Objects.equals(Robot.ds.getAlliance(), DriverStation.Alliance.Blue) ? (-1 * angle) : angle;
