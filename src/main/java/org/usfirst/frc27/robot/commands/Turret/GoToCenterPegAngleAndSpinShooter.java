 ...
 */
public class GoToCenterPegAngleAndSpinShooter extends Command {
	...
	protected void execute() {
		if (Robot.state.isManualOverride()) {
			Robot.shooter.spinShooterAtSpeedWithAngle(3650, Robot.turret.getAngle());
		} else {
			...
			Robot.shooter.spinShooterAtSpeedWithAngle(3650, angle);
		}
